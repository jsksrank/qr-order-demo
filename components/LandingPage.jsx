        ...
        <div className="container">
          ...
          <div className="pain-grid">
            {[
              ...
              { icon: "💸", title: "発注の伝達ミス・過剰在庫", desc: "口頭やメモでの発注連絡で漏れが発生。不安から多めに頼んで、気づけば棚がパンパンに。在庫番では欠品データから発注点を自動で見直し、勘に頼らない発注を実現します。" },
            ].map((p, i) => (
        ...
        <div className="container">
          ...
          <div className="features-grid">
            {[
              ...
              { icon: "🔄", title: "使うほど賢くなる自動補正", desc: "在庫切れを起こした商品は、欠品データをもとに発注点を自動で見直し。同じ欠品の繰り返しを防ぎます。" },
        ...
        <div className="container">
          ...
          <div className="faq-list">
            {[
              ...
              ["カラー剤以外にも使えますか？", "はい。シャンプー、トリートメント、2剤、スタイリング剤、エステの施術用オイルやパック剤など、繰り返し発注が必要な商品すべてにお使いいただけます。タグの縁に油性ペンで色を付けることで、商品タイプに合わせた運用もできます。例えば「色なし＝開封したら外す」「赤＝ボトルが空になったら外す」「青＝残り3割で外す」など。独自ルールを追加したい場合は、緑や黒など好きな色で自由に拡張できます（色が増えすぎるとスタッフが迷うので、2〜3色がおすすめです）。"],
